...
Init ==
    ...
    /\  clients = [c \in Clients |-> [num_requests_sent |-> 0, view_number |-> 0]]
...
StartViewChangeMessagesCount(r) == Cardinality({msg \in DOMAIN msgs: msg.from = r /\ msg.payload.type = MsgTypeStartViewChange})
