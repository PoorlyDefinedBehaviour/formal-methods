...
\* BEGIN TRANSLATION (chksum(pcal) = "19ba0a1f" /\ chksum(tla) = "a9d4bcca")
VARIABLES pc, servers, load_balancer, update_flag, updated
...
vars == << pc, servers, load_balancer, update_flag, updated >>
